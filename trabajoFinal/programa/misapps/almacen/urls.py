...
from .viewsets import MiAppViewSetWorker, MiAppViewSetEquipment, MiAppViewSetMaterial, MiAppViewSetPpe, MiAppViewSetTool, MiAppViewSetLoan, MiAppViewSetPpeLoan
"""
urlpatterns = [
    path('', home, name='home'),
    ...
    path('ppeloan/add/exception/', views.exception_ppe_loan, name='exception_ppe_loan'),
...
router.register('worker', MiAppViewSetWorker)
router.register('equipment', MiAppViewSetEquipment)
router.register('material', MiAppViewSetMaterial)
router.register('tool', MiAppViewSetTool)
router.register('ppe', MiAppViewSetPpe)
router.register('loan', MiAppViewSetLoan)
router.register('ppeloan', MiAppViewSetPpeLoan)
